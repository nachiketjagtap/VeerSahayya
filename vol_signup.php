...
$passWord = $_POST['passWord'];
    ...
    $sql = "INSERT INTO 'Volunteers' ('fullName', 'gender', 'mail_ID', 'phoneNum', 'workDomain', 'fullAddress', 'city', 'state', 'zip', 'timeAvail', 'about', 'userName', 'passWord') VALUES('$fullName', '$gender', '$mail_ID', '$phoneNum', '$workDomain', '$fullAddress', '$city', '$state', '$zip', '$timeAvail', '$about', '$userName', '$passWord')" ;
...
<div class="container my-4">
        ...
        <form action ="/VeerSahayya/vol_signup.php" method="post">
  <div class="form-row my-4">
    <div class="form-group col-md-6 mx-4">
      <label for="fullName">Full Name</label>
      <input type="text" class="form-control" id="fullName" placeholder="FirstName MiddleName LastName">
    </div>
    ...
    <div class="form-group col-md-6 mx-4">
      ...
      <input type="email" class="form-control" id="mail_ID" placeholder="Email">
    </div>
    <div class="form-group col-md-4 mx-4">
  ...
  <div class="form-group col-md-3 mx-4">
    ...
    <input type="text" class="form-control" id="fullAddress" placeholder="1234 Main St">
  </div>
...
<label for="workDomain">Work Domain</label>
      <select id="workDomain" class="form-control">
...
<div class="form-group col-md-4 mx-4">
      ...
      <input type="text" class="form-control" id="timeAvail">
</div>
</div>
<div class="form-row">
<div class="form-group col-md-3 mx-4">
...
<div class="form-group mx-4">
  ...
  <button type="submit" name ="save_select" class="btn btn-primary">Sign Up</button>
  </div>
</form>
